         ...
         <section id="campaign" className="container mt-20 min-h-screen md:mt-0">
            ...
            <div className="mx-auto mt-14 grid grid-cols-1 gap-4 md:mx-0 md:grid-cols-2 xl:grid-cols-3">
               {[1, 2, 3, 4, 5, 6].map(item => (
                  <div key={item} className="group flex max-w-md flex-col justify-between overflow-hidden rounded-lg bg-secondary shadow backdrop-blur-md transition-transform duration-300 hover:scale-102">
                     <div>
                     ...
                     <div className="flex space-x-3 px-5 pb-4 pt-2">
                        <button type="button" className="inline-flex items-center rounded-lg bg-white px-5 py-2.5 text-center text-sm font-medium text-black hover:bg-slate-300">
